...
-- Généré le :  Mar 31 Mars 2015 à 14:27
...
(3, 1, 'Dans la forêt', 'forest.png', 'forest.png'),
...
ALTER TABLE `ce_place`
 ADD PRIMARY KEY (`idPlace`), ADD KEY `idCorpse` (`idCorpse`);
...
--
ALTER TABLE `ce_corpse`
MODIFY `idCorpse` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `ce_object`
--
ALTER TABLE `ce_object`
MODIFY `idObject` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
